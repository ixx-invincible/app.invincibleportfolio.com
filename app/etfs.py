...
def calculate_etfs():
    ...
    for symbol in symbols:
        ...
        if datetime.now(timezone.utc).astimezone().tzinfo.utcoffset(None)==timedelta(seconds=28800):
            ...
            df_weekly = yfin.download(symbol, start='2013-01-01', end='2023-02-01', interval="1wk")
        else:
            df = yfin.download(symbol, start='2012-12-31', end='2023-01-31')
            df_weekly = yfin.download(symbol, start='2012-12-31', end='2023-01-31', interval="1wk")
